...
useEffect(()=>{
    ...
    return (<>
        <ReseauWText Text="Gestion des réseaux sociaux"/>
            <Typography variant="h4" className={classes.soustitre}>Création de contenu original</Typography>
            <Typography variant="h5" className={classes.caption}>Feed Instagram</Typography>
            <Carousel imgs={imgsPostInsta} />
            <br/>
            <br/>
            <Typography variant="h5" className={classes.caption}>Template de stories</Typography>
            <Carousel imgs ={[story1, story2, story3, story4]} nbImgScroll={2} nbImgVisible={2}/>
            <br/>
            <br/>
            <Typography variant="h5" className={classes.caption}>Publications Facebook</Typography>
